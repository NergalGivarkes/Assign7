...
public class EventImpl implements IEvent, Comparable {
    ...
    private Element _eElement = null;
     ...
     */
    public int getHour() {
        return new Integer(_eElement.getAttribute("hour").getValue()).intValue();
    }
    ...
    public int getMinute() {
        return new Integer(_eElement.getAttribute("min").getValue()).intValue();
    }
    ...
    public CalendarDate getStartDate() {
        Attribute a = _eElement.getAttribute("startDate");
    ...
    public CalendarDate getEndDate() {
        Attribute a = _eElement.getAttribute("endDate");
        if (a != null) return new CalendarDate(a.getValue());
        return null;
    }
    /**
    ...
    public int getPeriod() {
        Attribute a = _eElement.getAttribute("period");
     ...
     */
    public String getId() {
        Attribute a = _eElement.getAttribute("id");
    ...
    public int getRepeat() {
        Attribute a = _eElement.getAttribute("repeat-type");
        if (a != null) return new Integer(a.getValue()).intValue();
        return 0;
    }
    /**
	...
	public boolean getWorkingDays() {
        Attribute a = _eElement.getAttribute("workingDays");
